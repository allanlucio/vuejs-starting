...
Vue.filter('ucwords',(valor) => { return valor.charAt(0).toUpperCase() + valor.slice(1);});
...
Vue.component('clubes-libertadores',ClubesRebaixados);
Vue.component('clubes-rebaixados',ClubesLibertadores);
